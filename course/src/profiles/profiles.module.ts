...
@Module({
  controllers: [ProfilesController], // The controllers array specifies that the ProfilesController should be included in this module, allowing it to handle incoming requests to the /profiles route and its sub-routes.
})
